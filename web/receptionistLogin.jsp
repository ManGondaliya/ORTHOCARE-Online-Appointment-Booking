<%-- 
    Document   : recptionistLogin
    Created on : Nov 21, 2024, 11:02:34 PM
    Author     : hp
--%>
...
<body>
    <header>
       <div class="header-container">
           <img src="img/plus-logo.jpg" alt="Hospital Icon" class="hospital-icon">
           <h1>MediBook</h1> 
    ...
    <div class="main-container">
        ...
        <div class="login-container">
            <h2>Receptionist Login</h2>
            <form action="receptionistDashboard.jsp" method="post">
